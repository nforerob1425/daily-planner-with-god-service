...
public class ApplicationDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            new Permission { Id = Guid.Parse("05958f1c-844a-43e9-9bcb-6667dad75670"), Description = "Puede ver la vista de Administracion de usuarios", SystemName = "CSUV" },
            new Permission { Id = Guid.Parse("0678fae5-e577-4fd5-a759-ae3fb0fd9d6b"), Description = "Puede ver las agendas", SystemName = "CSAG" },
            new Permission { Id = Guid.Parse("0a1f874b-af1c-4b3f-8d3e-2714eb2a6ca4"), Description = "Puede crear tarjetas", SystemName = "CCCD" },
            new Permission { Id = Guid.Parse("0aaa962a-8d64-4515-9659-63e37f98c8ca"), Description = "Puede actualizar las configuraciones del sistema", SystemName = "CUAP" },
            new Permission { Id = Guid.Parse("0fe9b79f-8bf5-4742-8284-5414494988b0"), Description = "Puede actualizar sus anuncios", SystemName = "CUNW" },
            new Permission { Id = Guid.Parse("161ab07a-92d0-422e-a7df-20e69238dad7"), Description = "Puede actualizar usuarios", SystemName = "CUUS" },
            new Permission { Id = Guid.Parse("19f3b0e7-cc0b-44ba-ad7f-3ad17bcc9949"), Description = "Puede ver la vista del R07",   SystemName = "CSPV" },
            new Permission { Id = Guid.Parse("1f52010f-c57c-4031-a666-4ad9c4076404"), Description = "Puede actualizar peticiones", SystemName = "CUPT" },
            new Permission { Id = Guid.Parse("24395707-0c33-42fe-bc05-39bd9b5e0485"), Description = "Puede crear anuncios", SystemName = "CCNW" },
            new Permission { Id = Guid.Parse("2ad66724-24d7-4a86-b512-7cf5a4c4bfc3"), Description = "Puede asignar permisos temporales", SystemName = "CCTP" },
            new Permission { Id = Guid.Parse("2dd17f8f-6e80-4e60-919d-e304b90d0f46"), Description = "Puede actualizar las configuraciones", SystemName = "CUCN" },
            new Permission { Id = Guid.Parse("2f6a2460-7e0c-4677-a9a7-0c90ac88e2c7"), Description = "Puede eliminar peticiones", SystemName = "CDPT" },
            new Permission { Id = Guid.Parse("348f5ae9-8ee7-40e1-bd13-0166e437ed1b"), Description = "Puede eliminar colores", SystemName = "CDCO" },
            new Permission { Id = Guid.Parse("3bd9aa44-f431-43a6-8b0a-ca99b77d100c"), Description = "Puede eliminar tarjetas", SystemName = "CDCD" },
            new Permission { Id = Guid.Parse("3fb76b0e-bcf6-45a0-a141-42873cff242c"), Description = "Puede ver las configuraciones del sistema", SystemName = "CSAP" },
            new Permission { Id = Guid.Parse("410edf32-53fb-4242-9ca1-009ae499fcca"), Description = "Puede ver la vista de Solicitudes", SystemName = "CSEV" },
            new Permission { Id = Guid.Parse("489facd4-0546-4e91-9d2d-26afc5e60080"), Description = "Puede ver la vista del Dashboard", SystemName = "CSDV" },
            new Permission { Id = Guid.Parse("4f7c081e-b834-4fed-acfb-10d54e8c8f11"), Description = "Puede reportar tarjetas", SystemName = "CRCD" },
            new Permission { Id = Guid.Parse("503fc79e-3f52-435b-9222-254c8c1fc738"), Description = "Puede ver la vista de Manejo de la aplicacion", SystemName = "CSHV" },
            new Permission { Id = Guid.Parse("54b2a2a2-eccb-4241-8ece-d4e5a9beebaa"), Description = "Puede actualizar colores", SystemName = "CUCO" },
            new Permission { Id = Guid.Parse("54e3c968-e8d4-4b43-87d6-6351076e0093"), Description = "Puede eliminar usuarios", SystemName = "CDUS" },
            new Permission { Id = Guid.Parse("588ec542-ed55-4e66-9215-1c9216c5c914"), Description = "Puede descargar el reporte del mes", SystemName = "CDWCD" },
            new Permission { Id = Guid.Parse("5bada406-7bf0-41e7-8f6c-52f65760181c"), Description = "Puede ver la vista del Inicio", SystemName = "CSHV" },
            new Permission { Id = Guid.Parse("6a088364-cfa7-4e7c-8a31-17cddc9f1370"), Description = "Puede ver los anuncios", SystemName = "CSNW" },
            new Permission { Id = Guid.Parse("717a6cae-0844-4666-9621-c7082a8b9539"), Description = "Puede ver las configuraciones", SystemName = "CSCN" },
            new Permission { Id = Guid.Parse("72d1cb2c-30b0-4b6c-a9cd-d471940f7b93"), Description = "Puede ver los colores", SystemName = "CSCO" },
            new Permission { Id = Guid.Parse("75cf41d2-ca8f-4cb0-a37c-e3b34ddcb8c9"), Description = "Puede crear usuarios", SystemName = "CCUS" },
            new Permission { Id = Guid.Parse("7816c0b8-4db8-4a8b-b171-824a179709d2"), Description = "Puede ver las tarjetas del R07", SystemName = "CSCD" },
            new Permission { Id = Guid.Parse("8682fd93-c365-48f6-a363-720fd272a589"), Description = "Puede ver los permisos temporales", SystemName = "CSTP" },
            new Permission { Id = Guid.Parse("8cbaaf22-3f25-4e50-b4b9-cc5f4a78ba6c"), Description = "Puede crear agendas", SystemName = "CCAG" },
            new Permission { Id = Guid.Parse("9054c555-4a30-495b-95d4-fff561ce11c6"), Description = "Puede crear notas", SystemName = "CCNT" },
            new Permission { Id = Guid.Parse("90d0aaaf-793c-4cde-89ea-706cdd0c1a6d"), Description = "Puede actualizar notas", SystemName = "CUNT" },
            new Permission { Id = Guid.Parse("929d0a6d-6b2d-4391-aa79-c4859b9cfa57"), Description = "Puede eliminar agendas", SystemName = "CDAG" },
            new Permission { Id = Guid.Parse("a4f2229d-cd70-4c4f-a0fa-39e2f9e4a639"), Description = "Puede ver los usuarios", SystemName = "CSUS" },
            new Permission { Id = Guid.Parse("b3deaccb-bd01-4cd6-a543-9a001a93101c"), Description = "Puede ver las peticiones", SystemName = "CSPT" },
            new Permission { Id = Guid.Parse("ba75c802-413c-4209-abb5-d92fe883061c"), Description = "Puede desasignar permisos temporales", SystemName = "CDTP" },
            new Permission { Id = Guid.Parse("bbb2b3dc-b3a5-4ce4-811c-7750cba00c59"), Description = "Puede eliminar notas", SystemName = "CDNT" },
            new Permission { Id = Guid.Parse("c7f65971-5dcf-45e8-b146-3df6a710df2c"), Description = "Puede eliminar sus anuncios", SystemName = "CDNW" },
            new Permission { Id = Guid.Parse("cbd3a20b-a12a-437d-b130-ef77cb174edf"), Description = "Puede ver la vista de las Configuraciones", SystemName = "CSCV" },
            new Permission { Id = Guid.Parse("cc7d6a95-da2c-4eca-b0fd-7e711600027e"), Description = "Puede ver la vista del Perfil", SystemName = "CSPRV" },
            new Permission { Id = Guid.Parse("d274575a-c4f2-4d0a-ab6a-c634fabf9c15"), Description = "Puede actualizar agendas", SystemName = "CUAG" },
            new Permission { Id = Guid.Parse("dc508983-5917-4752-8ccc-1c6674234417"), Description = "Puede crear colores", SystemName = "CCCO" },
            new Permission { Id = Guid.Parse("e7c19a6f-64d5-47a7-bb93-00aa103a884a"), Description = "Puede ver sus notas", SystemName = "CSNT" },
            new Permission { Id = Guid.Parse("ee46d590-2457-4b01-95f1-3af291450552"), Description = "Puede crear peticiones", SystemName = "CCPT" },
            new Permission { Id = Guid.Parse("f6042a14-5907-4a6e-9417-0519cc422160"), Description = "Puede actualizar tarjetas", SystemName = "CUCD" },
            new Permission { Id = Guid.Parse("ffe00ecd-e320-4a9d-84d7-2d3b2d16aa7b"), Description = "Puede ver la vista de Peticiones", SystemName = "CSPTV" }
        };
