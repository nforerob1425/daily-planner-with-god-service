...
namespace Daily.Planner.with.God.Persistance.Migrations
{
    ...
    [Migration("20250404142156_PriorityPermission")]
    partial class PriorityPermission
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Daily.Planner.with.God.Domain.Entities.TemporalPermission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("315dade7-a364-4729-ada3-bcf99ce44a57"),
                            PermissionId = new Guid("96f97762-8b1e-46d8-8450-f52e85c2c2ac"),
                            RoleId = new Guid("26c52004-d441-48d8-8e00-e2cea7e1d55a")
                        },
                        new
                        {
                            Id = new Guid("57dec3c3-5278-4cde-bcb3-804e1db105a1"),
                            PermissionId = new Guid("95a80530-1b8a-4a6b-9c88-d0f57ad03fcb"),
                            RoleId = new Guid("26c52004-d441-48d8-8e00-e2cea7e1d55a")
                        },
                        new
                        {
                            Id = new Guid("b1bc8599-3dbe-46b1-8ce8-24f42980fe2e"),
                            PermissionId = new Guid("2a02728c-4408-4628-84bf-3b9650df5705"),
                            RoleId = new Guid("26c52004-d441-48d8-8e00-e2cea7e1d55a")
                        });
                });
